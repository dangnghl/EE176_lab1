...
REM
REM Generated by Vivado on Fri Sep 18 20:02:41 -0700 2026
...
echo "xvlog --incr --relax -L uvm -prj testbench_aludec_vlog.prj"
call xvlog  --incr --relax -L uvm -prj testbench_aludec_vlog.prj -log xvlog.log
